...
[2. К какому типа языка программирование относится Java?](#2-К-какому-типа-языка-программирование-относится-Java-Что-такое-исходный-код-Что-такое-байт-код)
...
## 2. К какому типа языка программирование относится Java? Что такое исходный код? Что такое байт-код?
